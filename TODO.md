...
### 🐛 Исправлено (2026-05-10 10:36)

- **Проблема:** Frontend пытался подключиться к неправильному IP (`192.168.0.233`)
- **Решение:** Обновлён `.env.local` с `192.168.0.233` на `192.168.0.232`
- **Результат:** Frontend теперь запущен на `https://192.168.0.232:5174/`
